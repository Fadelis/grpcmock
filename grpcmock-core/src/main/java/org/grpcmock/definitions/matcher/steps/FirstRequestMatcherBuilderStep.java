...
public interface FirstRequestMatcherBuilderStep<BUILDER extends FirstRequestMatcherBuilderStep<BUILDER, ReqT>, ReqT> extends
   ...
   * <p>This is used for client and bidi streaming requests. Only the first request can be used for matching,
   * as stub stub needs to be selected at this point or reject the call.
